...
#define SYSEX_CONFIGURATION_DIGITAL_BUS_ENABLE       "DE"
#define SYSEX_CONFIGURATION_DIGITAL_BUS_FORWARD_MIDI "DM"
#define SYSEX_CONFIGURATION_DIGITAL_BUS_PEERS        "DP"
#define SYSEX_CONFIGURATION_DIGITAL_BUS_STATUS       "DS"
