 ...
 */
#define VAL_GPIOA_MODER             (PIN_MODE_ALTERNATE(GPIOA_ARD_A0) |         \
                                     PIN_MODE_ALTERNATE(GPIOA_ARD_A1) |         \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_ARD_A0, 8U) |        \
                                     PIN_AFIO_AF(GPIOA_ARD_A1, 8U) |        \
